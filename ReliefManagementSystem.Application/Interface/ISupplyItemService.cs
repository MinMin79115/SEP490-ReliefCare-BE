...
namespace ReliefManagementSystem.Application.Interface
{
    ...
    public interface ISupplyItemService
    {
        ...
        /// <summary>Gets all supply items, optionally filtered by category.</summary>
        Task<IReadOnlyList<SupplyItemResponse>> GetAllSupplyItemsAsync(SupplyCategory? category = null, CancellationToken cancellationToken = default);
