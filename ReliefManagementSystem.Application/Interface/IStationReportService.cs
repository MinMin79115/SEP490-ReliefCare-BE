...
namespace ReliefManagementSystem.Application.Interface
{
    public interface IStationReportService
    {
        ...
        Task<Pagination<VehicleUtilizationReportItemDto>> GetVehicleUtilizationReportAsync(DateTime? from, DateTime? to, int pageIndex, int pageSize, CancellationToken cancellationToken = default);
