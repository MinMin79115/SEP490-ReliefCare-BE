...
namespace ReliefManagementSystem.Application.Interface
{
    public interface ITeamService
    {
        ...
        Task<Pagination<TeamResponse>> GetAllTeamsAsync(SearchTeamRequest request, CancellationToken cancellationToken);
        Task<Pagination<TeamResponse>> SearchTeamsAsync(SearchTeamRequest request, CancellationToken cancellationToken);
        Task<Pagination<TeamResponse>> GetTeamsInStationAsync(GetTeamsInStationRequest request, CancellationToken cancellationToken);
